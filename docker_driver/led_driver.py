...
class LedMessage:
    def __init__(self, msg):
        ...
        )  # initialize a matrix display object
    ...
    def start(self):
        self.process = multiprocessing.Process(
            target=self._show_msg, args=(), kwargs={}
        )  # initialize a process to repeatedly write the message
    ...
    def _clear(self):
        show_message(
            self.device, "", fill="white", font=proportional(LCD_FONT), scroll_delay=0
        )  # write a blank message to clear the screen
